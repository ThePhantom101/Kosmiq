...
## Corpus Check
- 141 files · ~60,570 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 604 nodes · 919 edges · 120 communities (110 shown, 10 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 244 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0f2b3bb5`
...
- [[_COMMUNITY_Ask Raj Jyotishi|Ask Raj Jyotishi]]
- [[_COMMUNITY_Charts List|Charts List]]
...
- [[_COMMUNITY_North Indian Chart UI|North Indian Chart UI]]
- [[_COMMUNITY_Astrolabe Loader|Astrolabe Loader]]
...
10. `IntelligenceCard()` - 11 edges

## Surprising Connections (you probably didn't know these)
- `DashboardPage()` --calls--> `useSession()`  [INFERRED]
  apps/web/src/app/(dashboard)/dashboard/page.tsx → apps/web/src/hooks/useSession.ts
...
Cohesion: 0.14
Nodes (59): AntardashaDetail, BiodataRequest, ChartRequest, ChartResponse, CompatibilityNarrativeRequest, CompatibilityRequest, CompatibilityResponse, CurrentTransitsResponse (+51 more)
...
Cohesion: 0.12
Nodes (8): useChartStrengths(), ChartHeroBanner(), MetricCards(), MetricCardsSkeleton(), QuickLinks(), deriveBestHouse(), derivePlanetMetrics(), normalizeScores()

### Community 7 - "Astro Engine"
Cohesion: 0.13
Nodes (6): AstrolabePage(), BiodataCalibrationPage(), useAstro(), LaboratoryPage(), SamhitaMatches(), StrengthsPage()

### Community 8 - "NavHUD Component"
Cohesion: 0.14
Nodes (8): ChroniclesPage(), DashboardPage(), NexusCard(), NexusPage(), handleEmailLogin(), handleSocialLogin(), OraclePage(), SignaturePage()
...
Cohesion: 0.19
Nodes (5): AccountPage(), AuthGate(), handleSignOut(), useSession(), createClient()
...
Cohesion: 0.5
Nodes (3): handleNext(), RectificationPage(), runRectification()

### Community 24 - "Relationship Compatibility"
Cohesion: 0.5
Nodes (5): Astro Engine, Docker, Kosmiq Web App, Supabase, Vedic Intelligence

### Community 26 - "Panchang Module"
Cohesion: 0.83
Nodes (3): addYears(), buildAntardashas(), getDashaSequenceFrom()

### Community 28 - "Account Settings"
Cohesion: 0.83
Nodes (3): GET(), POST(), proxyRequest()

### Community 30 - "Charts List"
Cohesion: 0.83
