...
- **Why does `compute_yogas_logic()` connect `Auth Callback` to `Predictions Area`, `Celestial Calculations`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `detect_all_yogas()` connect `Celestial Calculations` to `Auth Callback`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `get_flags()` connect `Astro Engine Service` to `Predictions Area`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
